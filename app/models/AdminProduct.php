...
class AdminProduct
{
    ...
    {
        $sql = 'SELECT * FROM config WHERE type=:type ORDER BY value ASC';
    ...
    public function updateProduct($data)
    {
        ...
        // Una posible pregunta de examen sería quitar $query->execute($params), es decir, el if entero, y retornar eso directamente
        // y quitar $errors[]
